        ...
        <el-table :data="reqFile">
            <el-table-column label="文件" prop="file">
                <template slot-scope="scope">
                    <el-select size="small" style="width: 50%" v-model="reqFile[scope.$index].id" filterable clearable placeholder="请选择文件">
...
export default {
  ...
  methods: {
    getFiles(){
        let url = '/auto_test/file/all/' + this.$store.state.projectId;
