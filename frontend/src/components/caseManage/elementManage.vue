<template>
  <div>
    ...
    <el-col :span="20" class="right-table">
        <!--列表-->
        <el-table size="small" :data="elementData" v-loading="loading" element-loading-text="拼命加载中">
            ...
            <el-table-column fixed="right" align="operation" label="操作" width="100">
                <template slot-scope="scope">
                    ...
                    <el-button type="text" size="mini" @click="deleteElement(scope.row.id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页组件 -->
...
export default {
    ...
    methods: {
        ...
        getdata(searchParam) {
            this.loading = true;
            let url = '/auto_test/element/list/' + searchParam.page + '/' + searchParam.limit;
            let param = {
        ...
        submitElement() {
            ...
            this.$refs["addElementForm"].validate(valid => {
                if (valid) {
                    ...
                    this.addElementForm.moduleId = 'd0e50ae4-d484-420e-93e8-3c1f99067c9d';
                    let url = '/auto_test/element/save';
        ...
        deleteElement(id){
            ...
            .then(() => {
                let url = '/auto_test/element/delete/'+id;
