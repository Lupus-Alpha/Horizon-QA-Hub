...
<template>
    <div>
        ...
        <el-table size="small" :data="caseListData" v-loading="loading" @selection-change="handleSelectionChange" tooltip-effect="dark" ref="multipleTable">
            ...
            <el-table-column prop="type" label="用例类型" width="120">
            </el-table-column>
            <el-table-column prop="system" label="用例系统" width="120">
            </el-table-column>
...
<script>
import SelectTree from '../../caseManage/common/module/selectTree'
...
export default {
    ...
    methods: {
        ...
        handleSelectionChange(rows){
            this.selections.splice(0, this.selections.length);//添加前先清空selections已有的数据
