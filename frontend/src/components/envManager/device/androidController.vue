...
export default {
  ...
  created() {
   ...
   methods: {
          ...
          loadUserSettings() {
            return this.$get("/api/v1/user/settings").then(ret => {
          ...
          loadPackages() {
            ...
            //         versionCode: "",
            //       }
            //       this.$get(`${this.deviceUrl}/packages/${packageName}/info`).then(ret => {
          ...
          closeWindowWhenReleased(interval) {
            // setTimeout(() => {
            //   if (document.hidden) {
            //     this.$get("/api/v1/user/devices/" + udid)
            //       .done(ret => {
            ...
            //       })
            //   } else {
            //     this.$get("/api/v1/user/devices/" + udid + "/active")
            //       .done((ret) => {
